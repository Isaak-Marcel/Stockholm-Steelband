<script>
    ...
    const carouselPhotos = [
      `images\\Playaing steelband.png`,
      "images\\Image of people in steelband.png",
      "images\\Image of steelBand.png"
    ];
    ...
    <div class="lg:flex lg:justify-center lg:items-center gap-8">
      <div class="basis-2/4 lg:pl-10 lg:justify-end lg:block flex justify-center">
        ...
        <div class="relative lg:w-auto w-[470px] lg:h-[278px] h-[238px]">
          ...
          {/each}
          <button class="next-button" on:click={next}><RigthArrowIcon width={40} height={40} /></button>
          <button class="previous-button" on:click={previous}><LeftArrowIcon width={40} height={40}/></button>
